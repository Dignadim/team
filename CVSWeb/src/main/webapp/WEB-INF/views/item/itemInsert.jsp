			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<th style="text-align: center; width: 150px; vertical-align: middle;">상품 사진</th>
						<td>
							<input type="text" class="form-control" name="itemImage" value="" placeholder="사진 업로드 버튼을 클릭하세요." readonly onclick="openWin()" data-bs-toggle="tooltip" title="이미지를 등록하려면 텍스트 박스를 클릭하세요.">`
						</td>
					</tr>				
					<tr>
					...
					<tr>
						...
						<td>	
							<input type="text" class="form-control" placeholder='해시태그를 띄어쓰기로 구분해서 입력해주세요' name="hashTag" data-bs-toggle="tooltip" title="'안녕 감사'를 입력하면 '#안녕 #감사' 해시태그가 만들어져요!"/>		
						</td>						
					</tr>					
				</tbody>
				<tfoot>
