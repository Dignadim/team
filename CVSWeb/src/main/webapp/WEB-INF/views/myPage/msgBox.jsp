...
<body>
	...
	<div class="m-3 p-3 container" align="center">
		...
		<div class="mlist" id="mlist" style="display: block; overflow: auto;">
			<div style="font-size: 30px; margin: 50px 10px;">받은 쪽지함</div>
				...
				<tbody>
					...
					<c:forEach var="mvo" items="${mlist}">
						<tr>
							...
							<td style="vertical-align: middle;">
								<input type="button" class="btn btn-outline-light-sm" value="${mvo.msg}" data-bs-toggle="modal" data-bs-target="#staticBackdrop">							
							</td>
							<td style="vertical-align: middle;">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<input type="hidden" value="${mvo.mid}" id="fid" name="fid">
		...
		<div>
			<input type="button" class="btn btn-dark" value="창 닫기" onclick="self.close()">
		</div>	
	</div>
