	...
	<form class="m-3" action="insertOK" method="post" name='insertForm'>
		<table class="table" style="width: 900px; height: 450px; margin-left: auto; margin-right: auto; margin-top: 80px;">
			...
			<tr class="table-light">
				...
				<td colspan="3">
					시작일: <input type="date" class="form-control form-control-sm" style="display: inline !important; width: 150px;" name="startSch" placeholder="ex)2022-11-19"/>&nbsp;&nbsp;
					종료일: <input type="date" class="form-control form-control-sm" style="display: inline !important; width: 150px;" name="endSch" placeholder="하루만 하는 행사일 경우 비워놓습니다."/><br/>
					내용: <input type="text" class="form-control form-control-sm"  style="display: inline !important; width: 300px;" name="contentSch" placeholder="행사내용 간략히"/>
				</td>	
			</tr>
			<tr class="table-light">
