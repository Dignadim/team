	...
	<form class="m-3" action="updateOK" method="post">
		<table class="table" style="width: 900px; height: 450px; margin-left: auto; margin-right: auto; margin-top: 80px;">
			...
			<tr class="table-secodary">
				...
				<td colspan="3">
					시작일: <input type="date" class="form-control form-control-sm" style="display: inline !important; width: 150px;" name="startSch" placeholder="ex)2022-11-19" value=" ${schedVO.sYear}-${schedVO.sMonth}-${schedVO.sDay}"/>&nbsp;&nbsp;
					종료일: <input type="date" class="form-control form-control-sm" style="display: inline !important; width: 150px;" name="endSch" placeholder="하루만 하는 행사는 적을필요X." value=" ${schedVO.eYear}-${schedVO.eMonth}-${schedVO.eDay}"/><br/>
					내용: <input type="text" class="form-control form-control-sm" style="display: inline !important; width: 300px;" name="contentSch" placeholder="행사내용 간략히" value=" ${schedVO.event}"/>
				</td>	
			</tr>				
			<tr>
