		...
		<table class="table" style="width: 1000px; margin-left: auto; margin-right: auto;">
			...
			<tr align="center" class="table table-light">
				...
				<c:if test="${grade.trim().equals('y')}">
					<input class="btn btn-outline-primary btn-sm" type="button" value="자동 행사 등록" 
						 onclick="location.href='eventCrawling'"/>
					<input class="btn btn-outline-primary btn-sm" type="button" value="수동 행사 등록" 
