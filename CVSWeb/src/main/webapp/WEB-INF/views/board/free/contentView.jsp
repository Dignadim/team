			...
			<tr>
				<td colspan="4" align="right" style="border: 0px; outline: 0px;">
					...
					<span style="display: none;">
						<input type="button" id="realReport" data-bs-toggle="modal" data-bs-target="#report-modal">
					</span>
			...
			<div class="modal" id="report-modal" tabindex="-1">
				<form action="reportOK" method="post" name="reportFrm" id="reportFrm">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h1 class="modal-title" id="exampleModalLabel">게시글 신고</h1>
							...
							<div class="modal-body">
								<!-- 신고 사유 선택 -->
								<div class="mb-3">
									<label for="report-reason" class="form-label">신고사유</label>
								...
								<!-- 내용 입력 -->
								<div class="mb-3">
									<label for="report-content" class="form-label">내용</label>
								...
								<div style="display: none;">
									<input type="text" name="fb_idx" value="${fb_vo.fb_idx}" size="4" />
									<input type="text" name="currentPage" value="${currentPage}" size="4" />
									<input type="text" name="report_id" value="${id}" size="4" />
									<input type="text" name="report_subject" value="${fb_vo.fb_subject}" size="4">
								</div>
								<!-- 전송 버튼 -->
								<div align="right">
									<input type="button" class="btn btn-danger btn-sm" value="신고접수" id="reportOK"/>
								</div>
							</div>
						</div>
					</div>
