	...
	<form class="m-3" action="insertOK" method="post" name='insertForm'>
		<table class="table" style="width: 900px; height: 450px; margin-left: auto; margin-right: auto; margin-top: 80px;">
			...
			<tr class="table-light">
				...
				<td colspan="2">
					<input id="fb_content" onkeyup="insertItem()" class="form-control form-control-sm" type="text"
					 name="fb_content" style="height: 500px !important;" data-bs-toggle="tooltip" title="상품 이미지를 등록하려면 %상품%을 입력해보세요!">

				
<!-- 				<textarea id="fb_content" onkeyup="insertItem()" class="form-control form-control-sm" rows="15" name="fb_content" style="resize: none;" placeholder="내용을 입력해주세요.">&nbsp;</textarea>		
					<script>
					  ClassicEditor
