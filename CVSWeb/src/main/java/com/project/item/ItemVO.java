...
public class ItemVO {
	...
	public ItemVO(int idx, String category, String itemName, int itemPrice, String sellCVS, double averscore,
			String eventType, int eventSale, int hit, String itemImage, Date itemDate, String addItemName,
			String addItemImage) {
		super();
		this.idx = idx;
	...
	public String toString() {
		return "ItemVO [idx=" + idx + ", category=" + category + ", itemName=" + itemName + ", itemPrice=" + itemPrice
				...
				+ eventSale + ", hit=" + hit + ", itemImage=" + itemImage + ", itemDate=" + itemDate + ", addItemName="
				+ addItemName + ", addItemImage=" + addItemImage + "]";
	}
