...
public class EventboardList {
	...
	public EventboardList() { }
	public void initEventboardList(int pageSize, int totalCount, int currentPage) {
	...
	public ArrayList<EventboardVO> getList() {
		return list;
	}
	public void setList(ArrayList<EventboardVO> list) {
		this.list = list;
	}
